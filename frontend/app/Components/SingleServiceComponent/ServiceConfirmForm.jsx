...
const ServiceConfirmForm = ({onClose}) => {
      ...
      <div className="fixed inset-0 bg-black/50  z-50 flex items-center justify-center">
                {/* Modal Content */}
                    <div className="bg-white p-6 rounded-lg shadow-xl w-[90%] md:w-full max-w-md">
                        ...
                        <h2 className="text-lg text-gray-800 mb-4 font-lato font-semibold leading-6">Project: <span className="font-medium"> I will design or develop a responsive wordpress blog website.</span></h2>
                        <h2 className="text-lg text-gray-800 mb-4 font-lato font-semibold leading-6">Package: <span className="font-medium">  Standard </span></h2>
