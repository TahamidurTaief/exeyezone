          ...
          <div className="w-full ">
            <div>
              <h2 className="text-[var(--secondary)] text-4xl font-semibold xl:text-4xl 2xl:text-6xl">
                <span className="text-[var(--primary)]">500+</span> Digital
                <br />
                Products here
              </h2>
            ...
            <div className="flex flex-row mt-5 gap-6 items-center">
                            <div className="bg-[var(--third)] hover:bg-sky-400 hover:text-white text-sm font-lato px-7 py-3 rounded-md cursor-pointer">
                                <Link href="/"> <p className='justify-center items-center text-center font-semibold'>Contact Now</p></Link>
                            </div>

                            <div className="border-2 p-2 border-third hover:border-sky-400 rounded-md">
                              <Link href="">
                              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M7.96967 19.5303C7.7034 19.2641 7.6792 18.8474 7.89705 18.5538L7.96967 18.4697L14.439 12L7.96967 5.53033C7.7034 5.26406 7.6792 4.8474 7.89705 4.55379L7.96967 4.46967C8.23594 4.2034 8.6526 4.1792 8.94621 4.39705L9.03033 4.46967L16.0303 11.4697C16.2966 11.7359 16.3208 12.1526 16.1029 12.4462L16.0303 12.5303L9.03033 19.5303C8.73744 19.8232 8.26256 19.8232 7.96967 19.5303Z" fill="#3C3679"/>
                              </svg>
                              </Link>
                            </div>
