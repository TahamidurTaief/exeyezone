  ...
  return (
    <div className='mt-14 xl:mt-20 pb-20'>
        <div className="container relative">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap mt-10 justify-between gap-5">
                


                {/* GRAPHIC DESIGN */}
                <div className='flex flex-col p-5 rounded-lg border border-gray-300 w-full sm:w-[18.321rem]'>
                ...
                {/* E-COMMERCE SOLUTION */}
                <div className='flex flex-col 2xl:flex-row p-5 rounded-lg border border-gray-300 w-full sm:w-[18.321rem] 2xl:w-[38.5rem]'>
