    ...
    <div className='mt-14 xl:mt-20 pb-20'>
        <div className="container relative">
            ...
            <div className="flex flex-col xl:flex-row mt-10 gap-5">
                ...
                {/* GRAPHIC DESIGN */}
                <div className='flex flex-col p-5 rounded-lg border border-gray-300 w-full sm:w-[calc(50%-0.625rem)] lg:w-[calc(33.333%-0.834rem)] xl:w-[calc(33.333%-0.834rem)] 2xl:w-[calc(33.333%-0.834rem)]'>
                ...
                <div className='flex flex-col p-5 rounded-lg border border-gray-300 w-full sm:w-[calc(50%-0.625rem)] lg:w-[calc(33.333%-0.834rem)] xl:w-[calc(50%-0.625rem)] 2xl:w-[calc(33.333%-0.834rem)]'>
                    <svg width="47" height="47" viewBox="0 0 47 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* E-COMMERCE SOLUTION */}
                <div className='flex flex-col 2xl:flex-row p-5 rounded-lg border border-gray-300 w-full sm:w-[calc(50%-0.625rem)] lg:w-[calc(66.666%-0.417rem)] xl:w-[calc(50%-0.625rem)] 2xl:w-[calc(66.666%-0.417rem)]'>
                ...
                <div className='flex flex-col p-5 rounded-lg border border-gray-300 w-full sm:w-[calc(50%-0.625rem)] lg:w-[calc(33.333%-0.834rem)] xl:w-[calc(33.333%-0.834rem)] 2xl:w-[calc(33.333%-0.834rem)]'>
                    ...
                    <div className="flex flex-col gap-2 md:gap-4  mt-3">
                        <Link href="/services"><h2 className='font-raleway text-2xl  text-[var(--secondary)] font-semibold hover:text-[var(--primary)] duration-200'>Software Testing & QA</h2></Link>
                ...
                <div className="hidden xl:block xl:w-[280px] 2xl:w-[320px]">
                    <Image 
