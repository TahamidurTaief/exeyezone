...
import service_side_banner from "@/public/img/service_side_banner.jpg";
  ...
  const services = [
    {
      ...
      description: "We create visually compelling designs that elevate your brand and captivate your audience.",
      icon: (
    ...
    {
      title: "UI/UX Design",
      description: "We craft intuitive UIs and seamless UX designs that combine aesthetics and functionality, enhancing user satisfaction and engagement.",
      icon: (
    ...
    },
    {
      ...
      description: "We provide custom web design and development, delivering stunning visuals and robust systems for a seamless online presence.",
      icon: (
        <svg className="bg-[#FFEEEF] p-3 rounded-lg" xmlns="http://www.w3.org/2000/svg" width="47" height="47" viewBox="0 0 24 24">
          <g><path d="M20 1.25H4C2.48 1.25 1.25 2.48 1.25 4v16c0 1.52 1.23 2.75 2.75 2.75h16c1.52 0 2.75-1.23 2.75-2.75V4c0-1.52-1.23-2.75-2.75-2.75zM2.75 4c0-.69.56-1.25 1.25-1.25h16c.69 0 1.25.56 1.25 1.25v1.25H2.75zm18.5 16c0 .69-.56 1.25-1.25 1.25H4c-.69 0-1.25-.56-1.25-1.25V6.75h18.5zM5.3 14.53a.754.754 0 0 1 0-1.06l2.5-2.5c.29-.29.77-.29 1.06 0s.29.77 0 1.06L6.89 14l1.97 1.97c.29.29.29.77 0 1.06-.15.15-.34.22-.53.22s-.38-.07-.53-.22zm9.83 1.44L17.1 14l-1.97-1.97c-.29-.29-.29-.77 0-1.06s.77-.29 1.06 0l2.5 2.5c.29.29.29.77 0 1.06l-2.5 2.5c-.15.15-.34.22-.53.22s-.38-.07-.53-.22a.754.754 0 0 1 0-1.06zm-5.08 1.81 2.45-8c.12-.39.54-.62.94-.5s.62.54.5.94l-2.45 8a.76.76 0 0 1-.94.5.75.75 0 0 1-.5-.94z" fill="#000000"/></g>
        </svg>
      )
    },
    {
      title: "Software Dev",
      description: "We create innovative, user-friendly mobile apps that are engaging and aligned with your business goals.",
      icon: (
        <svg width="47" height="47" viewBox="0 0 47 47" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div className='mt-14 xl:mt-20 pb-20'>
        <div className="container relative" ref={containerRef}>
            <motion.h1 
              className='text-4xl md:text-4xl lg:text-5xl xl:text-6xl text-[var(--secondary)] font-raleway font-bold'
            ...
            <motion.div 
              className="flex flex-col xl:flex-row mt-10 gap-5"
              variants={containerVariants}
              initial="hidden"
              animate={isInView ? "visible" : "hidden"}
            >
                {/* Service Cards Container */}
                <div className="flex flex-col sm:flex-row flex-wrap justify-between gap-5 xl:flex-1">
                
                {/* Service Cards - First 4 */}
                {services.map((service, index) => (
                  <motion.div
                    ...
                    className={`flex flex-col p-5 rounded-lg border border-gray-300 bg-white cursor-pointer ${
                      index === 3 
                        ? 'w-full sm:w-[calc(50%-0.625rem)] lg:w-[calc(33.333%-0.834rem)] xl:w-[calc(50%-0.625rem)] 2xl:w-[calc(33.333%-0.834rem)]'
                        : 'w-full sm:w-[calc(50%-0.625rem)] lg:w-[calc(33.333%-0.834rem)] xl:w-[calc(33.333%-0.834rem)] 2xl:w-[calc(33.333%-0.834rem)]'
                    }`}
                  >
                    <div>
                      {service.icon}
                    ...
                    <div className="flex flex-col gap-2 md:gap-4 mt-3">
                      <Link href="/services">
                        <h2 className='font-raleway text-2xl text-[var(--secondary)] font-semibold hover:text-[var(--primary)] duration-200'>
                          {service.title}
                        </h2>
                      </Link>
                      <p className='text-gray-500 text-sm font-lato font-normal'>{service.description}</p>
                    </div>
                  </motion.div>
                ))}
                ...
                <motion.div
                  ...
                  className='flex flex-col 2xl:flex-row p-5 rounded-lg border border-gray-300 bg-white w-full sm:w-[calc(50%-0.625rem)] lg:w-[calc(66.666%-0.417rem)] xl:w-[calc(50%-0.625rem)] 2xl:w-[calc(66.666%-0.417rem)] cursor-pointer'
                >
                    <div className='2xl:flex 2xl:flex-col'>
                        <div>
                          <svg className="bg-[#FFEEEF] p-3 rounded-lg" xmlns="http://www.w3.org/2000/svg" width="47" height="47" viewBox="0 0 512 512" fill="currentColor">
                            <g><path d="M329.978 290.347H183.259a11.248 11.248 0 0 1-10.666-7.679l-52.806-157.82H87.224a12.772 12.772 0 0 1-12.912-12.265 12.5 12.5 0 0 1 12.5-12.735h35.863a20.992 20.992 0 0 1 19.907 14.331l50.58 151.168h126.652l26.319-85.738H197.962a12.772 12.772 0 0 1-12.913-12.265 12.5 12.5 0 0 1 12.5-12.735h167.192a11.247 11.247 0 0 1 10.752 14.548L340.73 282.4a11.246 11.246 0 0 1-10.752 7.947Z"></path><path d="M395.884 513.093H116.116a12.5 12.5 0 0 1 0-25h279.768a12.5 12.5 0 1 1 0 25Z"></path><path d="M461.967 417.279H50.033A52.092 52.092 0 0 1-2 365.246V73.7a52.092 52.092 0 0 1 52.033-52.03h411.934A52.092 52.092 0 0 1 514 73.7v291.546a52.092 52.092 0 0 1-52.033 52.033ZM50.033 46.67A27.064 27.064 0 0 0 23 73.7v291.546a27.064 27.064 0 0 0 27.033 27.033h411.934A27.064 27.064 0 0 0 489 365.246V73.7a27.064 27.064 0 0 0-27.033-27.03Z"></path><path d="M314.271 510.4a12.5 12.5 0 0 1-12.5-12.5v-91.85a12.5 12.5 0 0 1 25 0v91.85a12.5 12.5 0 0 1-12.5 12.5Z"></path><path d="M197.729 510.4a12.5 12.5 0 0 1-12.5-12.5v-91.85a12.5 12.5 0 0 1 25 0v91.85a12.5 12.5 0 0 1-12.5 12.5Z"></path><path d="M219.668 343.446a17.668 17.668 0 1 1 17.669-17.668 17.688 17.688 0 0 1-17.669 17.668Z"></path><path d="M289.332 343.446A17.668 17.668 0 1 1 307 325.778a17.689 17.689 0 0 1-17.668 17.668Z"></path></g>
                          </svg>
                        </div>
                ...
                <motion.div
                  ...
                  className='flex flex-col p-5 rounded-lg border border-gray-300 bg-white w-full sm:w-[calc(50%-0.625rem)] lg:w-[calc(33.333%-0.834rem)] xl:w-[calc(33.333%-0.834rem)] 2xl:w-[calc(33.333%-0.834rem)] cursor-pointer'
                >
                    <div>
                      <svg className="bg-[#FFEEEF] p-3 rounded-lg" xmlns="http://www.w3.org/2000/svg" width="47" height="47" viewBox="0 0 24 24" fill="none">
                        <rect width="47" height="47" rx="9" fill="#FFEEEF"/>
                        <path d="M9 11L12 14L22 4" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M21 12V19C21 19.5304 20.7893 20.0391 20.4142 20.4142C20.0391 20.7893 19.5304 21 19 21H5C4.46957 21 3.96086 20.7893 3.58579 20.4142C3.21071 20.0391 3 19.5304 3 19V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H16" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </div>
                    ...
                    <div className="flex flex-col gap-2 md:gap-4 mt-3">
                        ...
                        <p className='text-gray-500 text-sm font-lato font-normal'>We ensure your software is reliable and bug-free through comprehensive testing and quality assurance processes.</p>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className='hidden 2xl:block'>
                        <Image src={custom_dev_img} alt='Exeyezone custom development' placeholder="blur" width="500" />
                    </div>
                </motion.div>

                </div>

                {/* Vertical Banner - visible from xl screen */}
                <motion.div 
                  className="hidden xl:block xl:w-[280px] 2xl:w-[320px]"
                  initial={{ opacity: 0, x: 50 }}
                  animate={isInView ? { opacity: 1, x: 0 } : {}}
