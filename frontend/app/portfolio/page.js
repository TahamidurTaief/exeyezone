...
export const metadata = {
  ...
  keywords: 'software development, web development, mobile apps, UI/UX design, AI solutions, digital innovation, custom software, e-commerce, SaaS, portfolio, software company achievements, tech company statistics, Python development, Django, React, Next.js, Node.js',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Exeyezone Portfolio - Leading Software Development Company',
      },
    ],
    locale: 'en_US',
    type: 'website',
